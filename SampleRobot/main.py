...
while running:
    ...
    if key[pygame.K_r]:
        ...
        vehicle.rect.y = 300
        vehicle.angle = 0
    if key[pygame.K_0]: # rotate left 90 degree
        print("rotate left 90")
        vehicle.rotate_left = True
    if key[pygame.K_1]:  # rotate left 90 degree
        print("rotate right 90")
        vehicle.rotate_right = True
